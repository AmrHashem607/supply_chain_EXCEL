...
### Project Objective
- Build an **Excel‑based dashboard** that showcases critical supply chain KPIs  
- Provide interactive visual insights with filters and charts  
- Highlight trends and performance gaps for operational decision‑making
...
These fields are used to calculate important KPIs such as delivery performance and revenue trends.
